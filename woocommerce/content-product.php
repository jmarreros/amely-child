...
<div <?php post_class( $classes ); ?>>
	...
	<div class="product-info">
		...
		<div class="acf-product">
			<?php
				echo '<span>'.strip_tags( get_the_term_list( get_the_ID(), 'product_brand')).'</span>';

				do_action( 'woocommerce_shop_loop_item_title_amely' );
				//get_the_term_list( $post_id, 'product_brand', $before, $sep, $after );
			?>
